...
【筛选核心原则：准确性与一致性】
保留信息的标准：
1. **人物名称**：必须保留准确的人物姓名，不允许编造替代名称
2. **地点名称**：必须保留准确的地点、场景名称
3. **技能/道具名称**：必须保留准确的技能、功法、道具名称
4. **人物关系**：必须保留准确的人物关系描述
...
- 前一章结尾：{previous_chapter_excerpt}

- 用户补充指导：{user_guidance}
...
- **节奏与结构**：开篇200字内必须出现吸引读者的"钩子"；整体约{word_number}字，在1500字左右需安排一个小高潮；结尾需为下一章制造悬念。
- **下章引导**：下一章《{next_chapter_title}》的定位是「{next_chapter_role}」，这将影响你本章结尾悬念的设计方向。
- **知识参考**：涉及世界设定时，请参考：{filtered_context}
